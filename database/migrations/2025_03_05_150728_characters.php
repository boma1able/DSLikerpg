...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('characters', function (Blueprint $table) {
            ...
            $table->integer('school_buff_damage_bonus')->default(0);
            $table->integer('school_hit_chance_bonus')->default(0);
            $table->integer('school_buff_hit_chance_bonus')->default(0);
            $table->integer('school_magic_damage_bonus')->default(0);
            $table->integer('school_buff_magic_damage_bonus')->default(0);
            $table->integer('school_magic_hit_chance_bonus')->default(0);
            $table->integer('school_buff_magic_hit_chance_bonus')->default(0);
            $table->integer('school_strength_bonus')->default(0);
            $table->integer('school_buff_strength_bonus')->default(0);
            $table->integer('school_dexterity_bonus')->default(0);
            $table->integer('school_buff_dexterity_bonus')->default(0);
            $table->integer('school_intelligence_bonus')->default(0);
            $table->integer('school_buff_intelligence_bonus')->default(0);
            $table->integer('school_armor_bonus')->default(0);
            $table->integer('school_buff_armor_bonus')->default(0);
            $table->integer('school_mana_bonus')->default(0);
            $table->integer('school_buff_mana_bonus')->default(0);
