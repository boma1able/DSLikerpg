<div class="w-[83px] border-r-[3px] border-[#eee]">
    <div class="group relative">
        ...
        <div class="relative flex bg-[#6767677d] text-[8px] text-black">
            <span style="position: relative; z-index: 1; height: 8px; text-align: center; width: 100%; line-height: 12px; font-weight: 600">
                {{ $experience }} / {{ $requiredExperience }}
            </span>
            <span style="position: absolute; top: 0; left: 0; width: {{ ($experience / $requiredExperience) * 100 }}%;
                background: linear-gradient(90deg, #9afc63 0%, #43da2d 70%, #10a004 90%); height: 100%;">
            </span>
        </div>
